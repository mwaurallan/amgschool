...
Route::group(['middleware' => ['install']], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(['middleware' => ['permission']], function () {
            ...
            Route::get('students/get_students_new/{class_id}', 'StudentController@get_students_new');
            ...
            Route::any('reports/studentStatement', 'ReportController@studentStatement')->name('reports.studentStatement');
            Route::any('reports/studentAccounts', 'ReportController@studentAccounts')->name('reports.studentAccounts');
            Route::any('reports/studentBills', 'ReportController@studentBills')->name('reports.studentBills');
            ...
            //fee structure
            Route::resource('structure','FeeStructureController');
            Route::post('saveStructureDetails','FeeStructureController@saveStructureDetails');
            Route::delete('deleteItem/{id}','FeeStructureController@deleteItem');
            Route::get('structure/createStructureDetails/{id}','FeeStructureController@createStructureDetails');
        });
        ...
        Route::group(['middleware' => ['parent']], function () {
            ...
            Route::any('parent/feeStatement', 'Users\ParentController@feeStatement');
