	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="search_form" class="params-panel validate" action="{{ url('reports/studentAccounts') }}" method="post" autocomplete="off" accept-charset="utf-8">
					@csrf
					<div class="col-md-3">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($reports as $report)
                                    <tr>
                                        ...
                                        <td>{{ $report['name'] }}</td>
                                        <td>{{ $report['admn'] }}</td>
                                        <td class="text-right">{{ number_format($report['bbf']) }}</td>
                                        <td class="text-right">{{ number_format($report['currentFees']) }}</td>
                                        <td class="text-right">{{ number_format($report['totalBal']) }}</td>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">{{ number_format($reports->sum('currentFees')) }}</th>
