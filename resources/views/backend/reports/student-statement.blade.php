	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="search_form" class="params-panel validate" action="{{ url('reports/studentStatement') }}" method="POST" autocomplete="off" accept-charset="utf-8">
					@csrf
                ...
                <div class="col-md-12 params-panel" id="report">
                    ...
                    <h4>{{ $name }}</h4>
                    <h5>Admission: {{ $stu->register_no }}</h5>
                        ...
                        @if(count($statements))
                            ...
                            @php $balance = $balance + $c - $d @endphp
                                <tr>
                                    ...
                                    <td>{{ (!is_null($statement->payment_id)) ? $statement->payment->ref_number: '' }}</td>
