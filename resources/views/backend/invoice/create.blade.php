		...
		<div class="panel-body">
			<div class="col-md-6">
			  <div class="form-group">
				<label class="control-label">{{ _lang('Class') }}/All</label>
				<select name="class_id" id="class_id" class="form-control select2" onchange="get_students();" required>
...
<!--			<div class="col-md-6">
			  <div class="form-group">
				...
				<select name="section_id" id="section_id" onchange="get_students();" class="form-control select2" >
					<option value="">{{_lang('Select One') }}</option>
				</select>
			  </div>
			</div>-->
...
<script type="text/javascript">
	...
	function get_students(){
		...
		var link = "{{ url('students/get_students_new') }}"+class_id;
		$.ajax({
			url: link,
			beforeSend: function(){
			    $("#preloader").css("display","block");
